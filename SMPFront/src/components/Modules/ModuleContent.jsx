          ...
          <DrawerBody py={6} bg="#f2e8cf">
            <VStack spacing={8} align="stretch">
              ...
              >
                ...
                <FormControl isRequired>
                  <FormLabel color="#386641" fontWeight="semibold" fontSize="md">
                    Contenido del audio principal
                  </FormLabel>
                  <Input
                    name="mainAudio"
                    placeholder="Escribe lo que quieres que diga el audio principal"
                    onChange={handleInputChangeContent}
                    value={contentForm.mainAudio}
                    size="lg"
                    borderColor="#a7c957"
                    _hover={{ borderColor: "#6a994e" }}
                    _focus={{
                  ...
                  />
                  <FormHelperText color="#7ba05b">
                    Este será el audio que se reproduce al mostrar la pregunta
                  </FormHelperText>
                </FormControl>
              </Box>
              ...
              >
                ...
                <VStack spacing={5} align="stretch">
                  <OptionGroup optionNumber={1} audioName="audio1" answerName="answer1" />
                  <OptionGroup optionNumber={2} audioName="audio2" answerName="answer2" />
                  <OptionGroup optionNumber={3} audioName="audio3" answerName="answer3" />
                  <OptionGroup optionNumber={4} audioName="audio4" answerName="answer4" />
                </VStack>
              </Box>
            </VStack>
          </DrawerBody>
